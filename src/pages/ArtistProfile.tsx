...
export default function ArtistProfile() {
  ...
  // If userId param is provided (admin viewing), use that; otherwise use own user id
      ...
      <div className="space-y-6 max-w-3xl">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            {isViewingOther
              ? 'Lihat dan kelola profil artis pengguna ini'
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Profil ini digunakan untuk release musik</CardDescription>
              </div>
        ...
        <Card className="bg-card/50 border-border/50">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>Spotify</Label>
                <Input value={formData.spotify} onChange={(e) => setFormData(prev => ({ ...prev, spotify: e.target.value }))} placeholder="https://open.spotify.com/artist/..." disabled={!canEdit} />
              </div>
              <div className="space-y-2">
