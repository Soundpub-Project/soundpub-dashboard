...
DROP TRIGGER IF EXISTS update_profiles_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_profiles_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_profiles_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_profiles_timestamp ON soundpub.profiles CASCADE;
CREATE TRIGGER update_profiles_timestamp
BEFORE UPDATE ON soundpub.profiles
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_releases_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_releases_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_releases_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_releases_timestamp ON soundpub.releases CASCADE;
CREATE TRIGGER update_releases_timestamp
BEFORE UPDATE ON soundpub.releases
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_tracks_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_tracks_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_tracks_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_tracks_timestamp ON soundpub.tracks CASCADE;
CREATE TRIGGER update_tracks_timestamp
BEFORE UPDATE ON soundpub.tracks
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_payout_requests_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_payout_requests_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_payout_requests_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_payout_requests_timestamp ON soundpub.payout_requests CASCADE;
CREATE TRIGGER update_payout_requests_timestamp
BEFORE UPDATE ON soundpub.payout_requests
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_royalty_uploads_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_royalty_uploads_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_royalty_uploads_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_royalty_uploads_timestamp ON soundpub.royalty_uploads CASCADE;
...
DROP TRIGGER IF EXISTS update_balance_on_payout_status_change ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_balance_on_payout_status_change ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_balance_on_payout_status_change ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_balance_on_payout_status_change ON soundpub.payout_requests CASCADE;
...
-- TRIGGERS
-- =============================================
DROP TRIGGER IF EXISTS update_app_settings_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_app_settings_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_app_settings_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_app_settings_timestamp ON soundpub.app_settings CASCADE;
CREATE TRIGGER update_app_settings_timestamp
BEFORE UPDATE ON soundpub.app_settings
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_artist_profiles_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_artist_profiles_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_artist_profiles_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_artist_profiles_timestamp ON soundpub.artist_profiles CASCADE;
CREATE TRIGGER update_artist_profiles_timestamp
BEFORE UPDATE ON soundpub.artist_profiles
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_artists_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_artists_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_artists_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_artists_timestamp ON soundpub.artists CASCADE;
CREATE TRIGGER update_artists_timestamp
BEFORE UPDATE ON soundpub.artists
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_composer_royalties_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_composer_royalties_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_composer_royalties_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_composer_royalties_timestamp ON soundpub.composer_royalties CASCADE;
CREATE TRIGGER update_composer_royalties_timestamp
BEFORE UPDATE ON soundpub.composer_royalties
FOR EACH ROW EXECUTE FUNCTION soundpub.update_timestamp();

DROP TRIGGER IF EXISTS update_release_payments_timestamp ON soundpub.profiles CASCADE;
DROP TRIGGER IF EXISTS update_release_payments_timestamp ON soundpub.releases CASCADE;
DROP TRIGGER IF EXISTS update_release_payments_timestamp ON soundpub.tracks CASCADE;
DROP TRIGGER IF EXISTS update_release_payments_timestamp ON soundpub.release_payments CASCADE;
