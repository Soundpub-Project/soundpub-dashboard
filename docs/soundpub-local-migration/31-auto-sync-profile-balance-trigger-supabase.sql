...
-- Step 5: Rebuild all existing balances to ensure consistency
DO $$
BEGIN
  RAISE NOTICE 'Starting balance rebuild...';
  ...
  RAISE NOTICE 'All balances reset to 0';
  ...
  RAISE NOTICE 'Artist balances rebuilt';
  ...
  RAISE NOTICE 'Label balances rebuilt';
  RAISE NOTICE 'Profile Balance Sync Completed Successfully!';
END;
$$;
...
SELECT 
  ...
  COUNT(*) AS total_profiles_with_balance,
